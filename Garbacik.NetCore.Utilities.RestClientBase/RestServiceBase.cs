using Garbacik.NetCore.Utilities.RestClientBase.Attributes;
using Garbacik.NetCore.Utilities.RestClientBase.Attributes.HttpRequest;
using Garbacik.NetCore.Utilities.RestClientBase.Attributes.RequestParamTypes;
using Garbacik.NetCore.Utilities.RestClientBase.Authenticators;
using Garbacik.NetCore.Utilities.RestClientBase.Extensions;
using Garbacik.NetCore.Utilities.RestClientBase.Models;
using Garbacik.NetCore.Utilities.RestClientBase.Tools;
...
namespace Garbacik.NetCore.Utilities.RestClientBase
{
    public abstract class RestServiceBase
    {
        protected readonly IRestClient _restClient;

        private RestServiceBase() { }

        protected RestServiceBase(IRestClient restClient)
        {
